...
namespace WebAPI
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseAuthentication(); // Anahtar, giriþ anahtarý -> kullanýcýyý authenticate edicez -> kullanýcý adý þifresiyle ve token vasýtasýyla nerelere ne yapabilir kim neye yetkili bunlarý izliyo olucaz
